...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'fecha_ultima_modificacion'); ?>
		<?php echo $form->textField($model,'fecha_ultima_modificacion'); ?>
		<?php echo $form->error($model,'fecha_ultima_modificacion'); ?>
	</div>
